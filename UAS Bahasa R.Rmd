...
# Evaluate the model
conf_matrix = confusionMatrix(factor(predicted_classes_gbm), test_data$LULUS)
...
model_auc <- c(auc(roc_rf), auc(roc_dt), auc(roc_svm), auc(roc_knn), auc(roc_nb), auc(roc_lr), auc(roc_gbm))
